...
struct EnhancedSwollamaCLI {
    ...
    static func main() async {
        ...
        if !isConnected {
            ...
            print("  • Make sure Ollama is running: \(EnhancedTerminalStyle.neonGreen)ollama serve\(EnhancedTerminalStyle.reset)")
            print("  • Check if the host is correct: \(EnhancedTerminalStyle.gray)\(config.host)\(EnhancedTerminalStyle.reset)")
        ...
        do {
            ...
            print("\(EnhancedTerminalStyle.red)Unexpected error: \(error.localizedDescription)\(EnhancedTerminalStyle.reset)")
            if config.verbose {
